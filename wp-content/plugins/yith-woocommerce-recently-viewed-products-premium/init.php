 ...
 * @package YITH\RecentlyViewedProducts
 * @version 2.31.0
 */
...
function yith_wrvp_premium_install_woocommerce_admin_notice() {
	?>
	<div class="error">
		<p><?php esc_html_e( 'YITH WooCommerce Recently Viewed Products Premium is enabled but not effective. It requires WooCommerce in order to work.', 'yith-woocommerce-recently-viewed-products' ); ?></p>
	</div>
	<?php
}
...
if ( ! defined( 'YITH_WRVP_VERSION' ) ) {
	define( 'YITH_WRVP_VERSION', '2.31.0' );
}
