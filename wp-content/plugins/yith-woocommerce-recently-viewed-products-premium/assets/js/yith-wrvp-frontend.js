...
(function ($, window, document) {
    ...
    $.fn.yith_wrvp_slider = function() {
        ...
        items.each(function() {
            ...
            var is_slider       = $(this).data('slider') == 'yes' || $(this).data('slider') == '1',
                autoplay        = $(this).data('autoplay') == 'yes' || $(this).data('autoplay') == '1',
                ...
                $(this).find( ywrvp.products_selector ).not('.slick-initialized').slick({
                    ...
                    responsive: [
                        ...
                        },
                        {
                            breakpoint: 480,
                            settings: {
                                slidesToShow: ywrvp.slider_n_columns_breakpoint_480
                            }
                        }
                    ]
                });
