...
?>
<div class="yith-ajaxsearchform-container <?php echo isset( $class ) ? esc_attr( $class ) : ''; ?><?php echo apply_filters( 'yith_wcas_porto_header', false ) ? 'searchform' : ''; ?>">
	<form role="search" method="get" id="yith-ajaxsearchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
		<div class="yith-ajaxsearchform-container">
			...
			<?php if ( apply_filters( 'yith_wcas_submit_as_input', true ) ) : ?>
				<input type="submit" title="<?php echo wp_kses_post( apply_filters( 'yith_wcas_submit_label_title', get_option( 'yith_wcas_search_submit_label' ) ) ); ?>" id="yith-searchsubmit" value="<?php echo esc_attr( apply_filters( 'yith_wcas_submit_label', get_option( 'yith_wcas_search_submit_label' ) ) ); ?>" />
			<?php else : ?>
				<button type="submit" title="<?php echo wp_kses_post( apply_filters( 'yith_wcas_submit_label_title', get_option( 'yith_wcas_search_submit_label' ) ) ); ?>" id="yith-searchsubmit"><?php echo wp_kses_post( apply_filters( 'yith_wcas_submit_label', get_option( 'yith_wcas_search_submit_label' ) ) ); ?></button>
			<?php endif; ?>
