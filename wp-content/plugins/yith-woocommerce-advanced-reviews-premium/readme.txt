...
= 2.8.0 - Released on 15 April 2025 =

* New: support for WordPress 6.8
* Update: plugin framework

= 2.7.0 - Released on 25 March 2025 =

* New: support for WooCommerce 9.8
* Fix: scrolling issue when clicking on Reviews link

= 2.6.0 - Released on 17 February 2025 =

* New: support for WooCommerce 9.7
* Fix: fatal error calling a method on a null $sitepress

= 2.5.0 - Released on 23 January 2025 =

* New: support for WooCommerce 9.6
* Update: plugin framework
* Fix: prevent fatal error when loading reviews
* Fix: error on schedule box for suborders (YITH WooCommerce Multi Vendor)

= 2.4.0 - Released on 17 December 2024 =

* New: support for WooCommerce 9.5
* Update: plugin framework
* Dev: changed substr() to mb_substr() function to allow UTF-8 characters
* Dev: new filter 'yith_ywar_rating_link'
* Dev: added new filter yith_ywar_check_user_block_list_checkout

= 2.3.0 - Released on 07 November 2024 =

* New: support for WordPress 6.7
* New: support for WooCommerce 9.4
* Update: plugin framework

= 2.2.0 - Released on 16 September 2024 =

* New: support for WooCommerce 9.3
* Update: plugin framework

= 2.1.1 - Released on 13 August 2024 =

* New: support for WooCommerce 9.2
* Update: plugin framework

= 2.1.0 - Released on 22 July 2024 =

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* New: assign review to a specific user from admin panel
* New: "Verified buyer" badge
* New: show user's country
* New: set review author as "verified owner"
* New: review date editable
* New: users' initials as alternative avatar
* New: additional reviewer's name masking features
* New: reported review email
* Update: plugin framework
* Update: language files
* Update: French translation (provided by Amir Moradi)
* Fix: Review Coupons sent regardless of the category set
* Fix: HTML visible in tab name

= 2.0.5 - Released on 27 June 2024 =

* Update: plugin framework
* Update: language files
* Fix: fatal error with emails

= 2.0.4 - Released on 24 Jun 2024 =

* New: support for WooCommerce 9.0
* Update: plugin framework
* Update: language files
* Fix: options not saving if pagination setting is invalid
* Fix: missing comment closed check on shortcode and blocks
* Fix: WPML compatibility
* Fix: screen options hidden in all pages
* Fix: Review Request email not pointing to reviews tab
* Fix: double reviews conversion
* Dev: added yith_ywar_user_avatar_html filter

= 2.0.3 - Released on 27 May 2024 =

* Update: plugin framework
* Update: language files
* Fix: yith_ywar_update_reports action scheduled multiple times

= 2.0.2 - Released on 22 May 2024 =

* New: integration with YITH WooCommerce Customize My Account Page
* Update: plugin framework
* Fix: installation and syncronization issues
* Fix: review reminder email button style not applied
* Fix: issue with Breakdance Zero theme
* Fix: issue with PHP 8.2

= 2.0.1 - Released on 15 May 2024 =

* Update: YITH plugin framework
* Fix: issue with Divi theme
* Fix: issue with Porto theme
* Fix: fatal error on Dashboard if product was deleted

= 2.0.0 - Released on 9 May 2024 =

* New: support for WooCommerce 8.9
* New: improved frontend styles and UX
* New: overview dashboard
* New: multi-criteria rating
* New: multiple review boxes
* New: Review Reminder sub-module
* New: Review for Discounts sub-module
* New: new admin panel UI
* Update: YITH plugin framework
...
= 1.37.0 - Released on 14 March 2024 =

* New: support for WordPress 6.5
* New: support for WooCommerce 8.7
* Update: YITH plugin framework

= 1.36.0 - Released on 22 February 2024 =

* New: support for WooCommerce 8.6
* Update: YITH plugin framework

= 1.35.1 - Released on 30 January 2024 =

* Update: YITH plugin upgrade
* Dev: added new filter yith_ywar_add_review_rating_title
* Dev: added new filter yith_ywar_add_review_attachments_title

= 1.35.0 - Released on 03 January 2024 =

* New: support for WooCommerce 8.5
* Update: YITH plugin framework

= 1.34.0 - Released on 12 December 2023 =

* New: support for WooCommerce 8.4
* Update: YITH plugin framework

= 1.33.0 - Released on 13 November 2023 =

* New: support for WordPress 6.4
* New: support for WooCommerce 8.3
* Update: YITH plugin framework

= 1.32.0 - Released on 04 October 2023 =

* New: support for WooCommerce 8.2
* Update: YITH plugin framework

= 1.31.0 - Released on 13 September 2023 =

* New: support for WooCommerce 8.1
* Update: YITH plugin framework

= 1.30.0 - Released on 09 August 2023 =
...
= 1.29.0 - Released on 06 July 2023 =

* New: support for WooCommerce 7.9
* Update: YITH plugin framework

= 1.28.0 - Released on 06 June 2023 =

* New: support for WooCommerce 7.8
* Update: YITH plugin framework
* Dev: added new filter yith_ywar_show_review_template

= 1.27.0 - Released on 08 May 2023 =

* New: support for WooCommerce 7.7
* Update: YITH plugin framework

= 1.26.0 - Released on 11 April 2023 =

* New: support for WooCommerce HPOS feature
* New: support for WooCommerce 7.6
* Update: YITH plugin framework
* Fix: allow multiple review forms in the same page

= 1.25.0 - Released on 06 March 2023 =

* New: Support for WordPress 6.2
* New: support for WooCommerce 7.5
* Update: YITH plugin framework
* Dev: added container element in the yith_ywar_show_reviews shortcode
* Dev: new filters 'yith_ywar_review_is_helpful' and 'yith_ywar_was_helpful_message'

= 1.24.0 - Released on 08 February 2023 =

* New: support for WooCommerce 7.4
* Update: YITH plugin framework
* Fix: Changed some deprecated methods from Elementor widgets

= 1.23.0 - Released on 04 January 2023 =

* New: support for WooCommerce 7.3
* Update: YITH plugin framework

= 1.22.0 - Released on 05 December 2022 =
...
= 1.21.0 - Released on 26 October 2022 =

* New: support for WordPress 6.1
* New: support for WooCommerce 7.1
* Update: YITH plugin framework

= 1.20.0 - Released on 04 October 2022 =

* New: support for WooCommerce 7.0
* Update: YITH plugin framework

= 1.19.0 - Released on 13 September 2022 =

* New: support for WooCommerce 6.9
* Update: YITH plugin framework

= 1.18.0 - Released on 02 August 2022 =

* New: support for WooCommerce 6.8
* Update: YITH plugin framework
* Fix: modified Elementor deprecated method
* Fix: recursive error in the JS
* Dev: fix the upload input briefly appearing in the edit review section
* Dev: added new filter yith_ywar_email_field_label

= 1.17.0 - Released on 04 July 2022 =
