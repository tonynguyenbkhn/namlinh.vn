...
(
	function ( $ ) {
		var blockParams     = ywar_admin.blockParams,
		...
		$( '.yith-ywar-modules .module' ).on(
			'change',
			'.module__active-toggle .on_off',
			function () {
				...
				var data = {
					module:   moduleKey,
					action:   'yith_ywar_modules_action',
					request:  'switch_module_activation',
					context:  'admin',
					security: ywar_admin.nonces.modulesAction,
