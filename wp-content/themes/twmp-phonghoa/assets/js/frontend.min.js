...
/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7848);
...
function loopFix(_temp) {
  ...
  if (slides.length < slidesPerView + loopedSlides || swiper.params.effect === 'cards' && slides.length < slidesPerView + loopedSlides * 2) {
    (0,utils.u)('Swiper Loop Warning: The number of slides is not enough for loop mode, it will be disabled or not function properly. You need to add more slides (or make duplicates) or lower the values of slidesPerView and slidesPerGroup parameters');
...
/* harmony import */ var swiper_modules__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(7848);
...
/* harmony export */ });
/* unused harmony exports b, g, i, k, o */
...
function Thumb(_ref) {
  ...
  function init() {
    ...
    } else if ((0,utils.l)(thumbsParams.swiper)) {
