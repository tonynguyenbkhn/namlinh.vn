...
$selected_posts = $data['selectedPostIds'];
$posts_per_page = !empty($data['postsPerPage'] ) && (int) $data['postsPerPage'] > 0 ? $data['postsPerPage'] : 5;
...
if (! empty($selected_posts)) {
    $args_resent_post['post__in'] = $selected_posts;
    $args_resent_post['orderby']  = 'post__in';
}

$data['post_title_limit'] = $data['titleLimit'] ? $data['titleLimit'] : $data['post_title_limit'];
$data['post_excerpt_limit'] = $data['excerptLimit'] ? $data['excerptLimit'] : $data['post_excerpt_limit'];
$data['view_more_button'] = $data['textViewMore'] ? $data['textViewMore'] : $data['post_excerpt_limit'];
$count = 0;
        ...
        <article class="<?php echo esc_attr($_class); ?>">
            <div class="post-row__wrapper row">
                ...
                <div class="col-lg-4 col-md-5 col-sm-5 col-5">
                    <a class="post-row__overlay-link" href="<?php echo esc_url_raw(get_permalink($post_data)); ?>" title="">
                        <?php
