...
function wpgis_updates()
{
	...
	$options = $_POST;
	$update_val = array(
		'slider_layout' => !empty($options['wpgis_slider_layout']) ? sanitize_text_field($options['wpgis_slider_layout']) : '',
		'slidetoshow' =>  !empty($options['wpgis_slidetoshow']) ? sanitize_text_field($options['wpgis_slidetoshow']) : '',
		'slidetoscroll' => !empty($options['wpgis_slidetoscroll']) ? sanitize_text_field($options['wpgis_slidetoscroll']) : '',
		'sliderautoplay' => !empty($options['wpgis_sliderautoplay']) ? sanitize_text_field($options['wpgis_sliderautoplay']) : '',
		'arrowdisable' => !empty($options['wpgis_arrowdisable']) ? sanitize_text_field($options['wpgis_arrowdisable']) : '',
		'arrowinfinite' => !empty($options['wpgis_arrowinfinite']) ? sanitize_text_field($options['wpgis_arrowinfinite']) : '',
		'arrowcolor' => !empty($options['wpgis_arrowcolor']) ? sanitize_text_field($options['wpgis_arrowcolor']) : '',
		'arrowbgcolor' => !empty($options['wpgis_arrowbgcolor']) ? sanitize_text_field($options['wpgis_arrowbgcolor']) : '',
		'show_lightbox' => !empty($options['wpgis_show_lightbox']) ? sanitize_text_field($options['wpgis_show_lightbox']) : '',
		'show_zoom' => !empty($options['wpgis_show_zoom']) ? sanitize_text_field($options['wpgis_show_zoom']) : '',
    );
	return $update_val;
}
