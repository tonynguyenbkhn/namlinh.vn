...
if ( ! class_exists( 'YITH_WCAS' ) ) {
	...
	class YITH_WCAS {
		...
		public function load_compatibility() {
			...
			// YITH Membership.
			if ( class_exists( 'YITH_WCMBS_Products_Manager' ) && ! class_exists( 'YITH_WCAS_Membership_Support' ) ) {
				require_once YITH_WCAS_INC . 'compatibility/class-yith-wcas-membership-support.php';
				YITH_WCAS_Membership_Support::get_instance();
			}
