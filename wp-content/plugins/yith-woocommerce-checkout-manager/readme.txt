...
=== Version 1.36.0 === Released on 7 Feb 2024

* New: support for WooCommerce 8.6
* Update: YITH plugin framework

=== Version 1.35.0 === Released on 17 Jan 2024

* New: support for WooCommerce 8.5
* Update: YITH plugin framework
* Fix: billing state field required when no state is available

=== Version 1.34.0 === Released on 18 Dec 2023

* New: support for WooCommerce 8.4
* Update: YITH plugin framework
* Fix: set required not working on Billing Address 2

=== Version 1.33.0 === Released on 22 Nov 2023

* New: support for WordPress 6.4
* New: support for WooCommerce 8.3
* Update: YITH plugin framework

=== Version 1.32.0 === Released on 16 Oct 2023

* New: support for WooCommerce 8.2
* Update: YITH plugin framework

=== Version 1.31.0 === Released on 18 Sep 2023

* New: support for WooCommerce 8.1
* Update: YITH plugin framework
* Tweak: hide diabled fields in order billing and shipping fields.

=== Version 1.30.0 === Released on 08 Aug 2023

* New: support for WordPress 6.3
* New: support for WooCommerce 8.0
* Update: YITH plugin framework
* Tweak: add support for email subaddressing
* Fix: minor bugs

=== Version 1.29.0 === Released on 18 Jul 2023
...
=== Version 1.28.0 === Released on 22 Jun 2023
...
=== Version 1.27.0 === Released on 17 May 2023

* New: support for WooCommerce 7.7
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.26.0 === Released on 19 Apr 2023

* New: support for WooCommerce 7.6
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.25.0 === Released on 21 Mar 2023

* New: support for WordPress 6.2
* New: support for WooCommerce 7.5
* Update: YITH plugin framework
* Dev: filter the date formats only for this plugin
* Fix: minor bugs

=== Version 1.24.0 === Released on 21 Feb 2023

* New: support for WooCommerce 7.4
* Update: YITH plugin framework
* Tweak: prevent fatal error unset a non-array variable
* Fix: minor bugs

=== Version 1.23.0 === Released on 16 Jan 2023

* New: support for WooCommerce 7.3
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.22.0 === Released on 15 Dec 2022

* New: support for WooCommerce 7.2
* Update: YITH plugin framework
* Fix: sanitize field label to allow HTML
* Fix: minor bugs

=== Version 1.21.0 === Released on 15 Nov 2022
...
=== Version 1.20.0 === Released on 13 Oct 2022

* New: support for WooCommerce 7.0
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.19.0 === Released on 19 Sep 2022

* New: support for WooCommerce 6.9
* Update: YITH plugin framework
* Dev: improve admin add new field process
* Dev: new filter 'yith_wccp_show_always_additional_field_in_table'
* Fix: minor bugs

=== Version 1.18.0 === Released on 16 Aug 2022

* New: support for WooCommerce 6.8
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.17.0 === Released on 18 Jul 2022

* New: support for WooCommerce 6.7
* Update: YITH plugin framework
* Fix: undefined index billing_country
* Fix: minor bugs

=== Version 1.16.0 === Released on 22 Jun 2022

* New: support for WooCommerce 6.6
* Update: YITH plugin framework
* Fix: minor bugs

=== Version 1.15.0 === Released on 23 May 2022
...
=== Version 1.14.0 === Released on 06 April 2022

* New: support for WooCommerce 6.4
* Update: YITH plugin framework
* Update: language files

=== Version 1.13.0 === Released on 03 March 2022

* New: support for WooCommerce 6.3
* Update: YITH plugin framework
* Update: language files
* Dev: new filter 'ywccp_panel_capability'

=== Version 1.12.0 === Released on 10 February 2022

* New: support for WooCommerce 6.2
* Update: YITH plugin framework
* Update: language files

=== Version 1.11.0 === Released on 11 January 2022
...
=== Version 1.10.0 === Released on 02 December 2021

* New: support for WooCommerce 6.0
* Update: YITH plugin framework
* Update: language files
* Fix: custom fields not shown on thank you page and order edit page if fields has conditions

=== Version 1.9.0 === Released on 04 November 2021

* New: support for WooCommerce 5.9
* Update: YITH plugin framework
* Update: language files
* Dev: new filter 'ywccp_field_ids_to_exclude'

=== Version 1.8.0 === Released on 13 October 2021

* New: support for WooCommerce 5.8
* Update: YITH plugin framework
* Fix: added a condition to avoid prefix errors

=== Version 1.7.1 === Released on 27 September 2021

* Update: YITH plugin framework
* Fix: debug info feature removed for all logged in users

=== Version 1.7.0 === Released on 08 September 2021

* New: support for WooCommerce 5.7
* Update: YITH plugin framework

=== Version 1.6.4 === Released on 12 August 2021

* New: support for WooCommerce 5.6
* New: Russian translation
* Update: YITH plugin framework

=== Version 1.6.3 === Released on 05 July 2021

* New: support for WordPress 5.8
* New: support for WooCommerce 5.5
* Update: YITH plugin framework
* Fix: product in cart validate condition
* Fix: enable/disable field using bulk action

=== Version 1.6.2 === Released on 03 June 2021

* New: support for WooCommerce 5.4
* Update: YITH plugin framework
* Fix: checkout validation for products and categories conditions

=== Version 1.6.1 === Released on 13 May 2021

* New: support for WooCommerce 5.3
* Update: YITH plugin framework
* Fix: shipping costs didn't set properly
* Fix: issue with required condition
* Fix: prevent invalid condition fields to be processed
* Tweak: cache on field conditions to improve performance
